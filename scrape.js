...
var fs = require('fs');
var stream = fs.createWriteStream("restaurants1.json", {flags:'a'});

// Set Yelp's API key
const apiKey = 'Lvv-afuUi8Qmm6QsTonSNxpDe19vx8Bsr4BwIofb8umebR-Eq1gIBE04LuRi_eP7CtsN9ft5tjEEg865mYhTZGwm95SvmKe9zbxq6lN9lSyEfVb9KurVCZJEk3_oW3Yx';
...
for (var offset = 0; offset < 100; offset+= 20) {
    ...
    const searchRequest = {
        ...
        term: "burger",        // Define your own cuisine hoice
